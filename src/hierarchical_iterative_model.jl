...
t_3 = @elapsed opt_loc_3 = location_optimization_radius(mx_5, opt_loc_2[1][end], 100,
...
C1, C2, C3, C4, C5 = c1_c5_metrics(mx_5, final_nodes, metric, R, q)
...
results_df = DataFrame(datetime = Dates.now(), model_type = "hierarchical-iterative", metric = metric,
                       p = p, m = length(mx_5.v), n = length(mx_5.v), q = q, R = R, r = r,
